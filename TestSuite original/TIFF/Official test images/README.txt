$Header: /d1/sam/tiff/pics/RCS/README,v 1.6 1997/09/02 19:07:22 sam Exp $
...
-------------------------------------
pics/cramps.tif		800x607 8-bit b&w (packbits) "cramps poster"
pics/cramps-tile.tif	256x256 tiled version of cramps.tif (no compression)
pics/fax2d.tif		1728x1082 1-bit b&w (G3/2D) facsimile
pics/g3test.g3		raw Group 3 encoded fax file
pics/g3test.tif		TIFF equivalent of g3test.g3 created by fax2tiff
pics/jello.tif		256x192 8-bit RGB (lzw palette) Paul Heckbert "jello"
pics/off_l16.tif	333x225 8-bit CIE LogL (SGILog) office from Greg Larson
pics/off_luv24.tif	333x225 8-bit CIE LogLuv (SGILog24) office from " "
pics/off_luv32.tif	333x225	8-bit CIE LogLuv (SGILog) office from " "
pics/quad-jpeg.tif	512x384 8-bit YCbCr (jpeg) version of quad-lzw.tif
pics/quad-lzw.tif	512x384 8-bit RGB (lzw) "quadric surfaces"
pics/quad-tile.tif	512x384 tiled version of quad-lzw.tif (lzw)
pics/strike.tif		256x200 8-bit RGBA (lzw) "bowling pins" from Pixar
pics/text.tif		1512x359 4-bit b&w (thunderscan) am-express credit card
pics/ycbcr-cat.tif	250x325 8-bit YCbCr (lzw) "kitty" created by rgb2ycbcr

pics/smallliz.tif	160x160 8-bit YCbCr (OLD jpeg) lizard from HP**
pics/zackthecat.tif	234x213 8-bit YCbCr (OLD jpeg) tiled "ZackTheCat" from NeXT**
...
-------------------------------------------
pics/oxford.tif		601x81 8-bit RGB (lzw) screendump off oxford
...
pics/jim___cg.tif      A	    Y
pics/jim___dg.tif      B	    N
pics/jim___gg.tif      B	    Y
